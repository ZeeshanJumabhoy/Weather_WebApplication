...
function changeWeatherColor(classarg) {
  const weatherElement = document.querySelector('.weather');
  if (classarg === 'Rain') {
    weatherElement.style.color = 'blue'; // Change color to blue for rain
  } else if (classarg === 'Haze') {
    weatherElement.style.color = 'pink';
  }
  else if (classarg === 'Clouds') {
    weatherElement.style.color = 'gray'; // Change color to gray for clouds
  } else if (classarg === 'Clear') {
    weatherElement.style.color = 'yellow'; // Change color to yellow for clear weather
  } else if (classarg === 'Snow') {
    weatherElement.style.color = 'white'; // Change color to white for snow
  } else if (classarg === 'Sunny') {
    weatherElement.style.color = 'orange'; // Change color to orange for sunny weather
  } else if (classarg === 'Mist') {
    weatherElement.style.color = 'lightgray'; // Change color to light gray for mist
  } else if (classarg === 'Thunderstorm' || classarg === 'Drizzle') {
    weatherElement.style.color = 'darkblue'; // Change color to dark blue for thunderstorm or drizzle
  } else {
    weatherElement.style.color = '#000'; // Default color (black)
  }
}
